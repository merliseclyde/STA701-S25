...
-   Any students who will need to change the date of the presentation should submit a [request](https://github.com/merliseclyde/sta701-S25/issues/new/choose) in Github.[^1] Please provide the alternate date(s) and confirmation that the other individual is willing to switch.

-   Please submit [titles and abstracts](https://github.com/merliseclyde/sta701-S25/issues/new/choose) at least one week in advance.
